...
void Game::UpdatePlayerTurn(string Player1Symbol, string Player2Symbol, string CurrentPlayerTurn, bool WinStatus) {
...
void Game::UserInput(Player& PlayerObject, vector<vector<string>> GameBoard) {
...
void Game::CheckTurn(Player& PlayerObject1, Player& PlayerObject2, vector<vector<string>> GameBoard) {
...
void Game::FirstPlayer(Player& PlayerObject1, Player& PlayerObject2, int XCount, int OCount) {
...
bool Game::WinCondition(vector<vector<string>> GameBoard) {
